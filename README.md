...
--
-->
[![.github/workflows/release.yaml](https://github.com/RiverBench/dataset-officegraph/actions/workflows/release.yaml/badge.svg?event=push)](https://github.com/RiverBench/dataset-officegraph/actions/workflows/release.yaml)
...
Full documentation for all versions can be found [on the website](https://w3id.org/riverbench/datasets/officegraph/dev).*
...
- **<abbr title="A related resource from which the described resource is derived.">Source</abbr>**: 
    - van der Weerdt, R., de Boer, V., Siebes, R., Groenewold, R., & van Harmelen, F. (2024). OfficeGraph: A Knowledge Graph of Office Building IoT Measurements. The Semantic Web, 94–109. [https://doi.org/10.1007/978-3-031-60635-9_6](https://doi.org/10.1007/978-3-031-60635-9_6)
...
- **<abbr title="Date on which the resource was changed.">Date Modified</abbr>**: 2025-01-24
